    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chooseHobbyGroup.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch(position)
                {
                    case 0:hobbyAdapter=(com.cognichamp.CogniChamp.hobbyAdapter)hobbyGroupRecycler.getAdapter();
                        ...
                        break;
                    case 1:
                        hobbyAdapter=(com.cognichamp.CogniChamp.hobbyAdapter)hobbyGroupRecycler.getAdapter();
                            if(hobbyAdapter!=null)
                                hobbyAdapter.saveChanges();
